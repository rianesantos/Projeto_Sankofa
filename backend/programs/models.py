...
class Program(models.Model):
    ...
    membros_inscritos = models.ManyToManyField(
        Member,
        through='Enrollment',
        related_name='programas_inscritos',
        blank=True,
    )
...
class Enrollment(models.Model):
    """
    Modelo de Ligação (trough model) que implementa:
    ...
    # Campos específicos do benefício
    ...
    def __str__(self):
        return f"{self.membro.nome_completp} inscrito em {self.programa.nome}"
