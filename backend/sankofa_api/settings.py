"""
Django settings for sankofa_api project.
...
SECRET_KEY = 'django-insecure-c6b-v#lj+g%^6s^i30g5vn%s3q%gw4z893(y5=s&ov2%p26-cg'
...
WSGI_APPLICATION = 'sankofa_api.wsgi.application'
